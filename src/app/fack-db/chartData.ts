...
export class ChartDB {
  ...
  static bar2CAC = {
    ...
    colors: ['#0F4E91', '#0e9e4a', '#ffc107', '#dc3545'],
    responsive: [
      {
        breakpoint: 480,
        options: {
  ...
  static bar4CAC = {
    ...
    colors: ['#0F4E91', '#00acc1', '#0e9e4a', '#ffc107', '#dc3545'],
    stroke: {
      width: 1,
      colors: ['#fff']
    },
  ...
  static scatter1CAC = {
    ...
    colors: ['#0F4E91', '#0e9e4a', '#dc3545', '#ffc107', '#00acc1'],
    series: [
      {
        name: 'SAMPLE A',
        data: [
  ...
  static pie1CAC = {
    ...
    colors: ['#0F4E91', '#0e9e4a', '#00acc1', '#ffc107', '#dc3545'],
    legend: {
      show: true,
      position: 'bottom'
    },
